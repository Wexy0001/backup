...
client.on("ready", () => {
  const log = message => {
    console.log(`[Acer KOMUT] - ${message}`)
  };
        ...
        if (!savedChannel) {
          if(channel.type === "voice"){
            ...
            let newChannelSchema = new ChannelData({
              ...
              type: channel.type,
              topic: channel.topic ? channel.topic : "Bu kanal Acer Backup botu tarafından geri yüklendi.",
              permissionOverwrites: permissionss,
            });
            newChannelSchema.save();
          }
          ...
          if(channel.type === "voice"){
            ...
            savedChannel.type = channel.type;
            savedChannel.time = Date.now();
            savedChannel.topic = channel.topic ? channel.topic : "Bu kanal Acer Backup botu tarafından geri yüklendi.";
            savedChannel.permissionOverwrites = permissionss;
            savedChannel.save();
          }
        };
